 ...
 *
 */
package net.mcreator.olympusmod;
...
@Mod("olympusmod")
public class OlympusmodMod {
	public static final Logger LOGGER = LogManager.getLogger(OlympusmodMod.class);
	public static final String MODID = "olympusmod";

	public OlympusmodMod() {
